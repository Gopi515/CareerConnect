...
<div class="app-main__inner">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6 float-left">
        	<div class="col-md-6 float-left">
        	<div class="card mb-3 widget-content" style="background: linear-gradient(180deg, #0083fa, #00ecff);">
            ...
            <div class="col-md-6 float-left">
            <div class="card mb-3 widget-content" style="width: 260px; background: linear-gradient(180deg, #0083fa, #00ecff);">
                <div class="widget-content-wrapper text-white">
                    <div class="widget-content-left">
