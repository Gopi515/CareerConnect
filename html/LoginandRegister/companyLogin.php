                ...
                <div class="withsubmit">
                    <div class="inputboxes">
                        ...
                        <div id="foreye" class="password-container logincont">
                            <input name="password" onpaste="return false;" autocomplete="off" required class="pwrdl" type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" id="password" placeholder="Password please" oninput="setCustomValidity('')">
                    ...
                    <div class="subdiv">
                        <p class="forgot-password"><a href="companyForgotPassword.php">Forgot Password?</a></p>
