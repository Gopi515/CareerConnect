        ...
        <div class="inner-whole-body">
            <table class="tablebody" border="1">
                <tr>
                    ...
                    <!-- internship table -->
                    <th onclick="sortTable(11)" data-column="11">Internship Topic<span class="sort-icon"></span></th>
                    <th onclick="sortTable(12)" data-column="12">Work Location<span class="sort-icon"></span></th>
                    <th onclick="sortTable(13)" data-column="13">Duration<span class="sort-icon"></span></th>
                    <th onclick="sortTable(14)" data-column="14">Stipend<span class="sort-icon"></span></th>
