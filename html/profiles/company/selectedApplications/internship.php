...
<body>
    <div class="heading1">
        <h1>Intern select application</h1>
    </div>
            ...
            <table border="1">
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td class='need-side'><a href='selectedInternshipApplication.php?id=" . htmlspecialchars($row['id'], ENT_QUOTES, 'UTF-8') . "'><p class='btn'>Selected candidates</p></a></td>";
                        echo "</tr>";
                    }
                } else {
