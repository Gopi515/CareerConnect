...
$query = "SELECT * FROM question_bank WHERE email = ? AND (Questions LIKE ? OR skills LIKE ?) LIMIT ?, ?";
...
$totalRecordsQuery = "SELECT COUNT(*) AS total FROM question_bank WHERE email = ? AND (Questions LIKE ? OR skills LIKE ?)";
