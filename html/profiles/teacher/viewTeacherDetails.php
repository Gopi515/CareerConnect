...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- main container -->
        <form action="#" method="POST"  class="tech-view-container">
            ...
            <div class="tech-hero-section">
                ...
                <div class="tech-language tech-view-language">
            ...
            <!-- end next button  -->
            <a href="../teacher/updateTeacherDetails.php" class="update-ar-a" >Update</a>
