...
if(isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM `skill_questions` WHERE `QID`= '$question_id' AND `email` = '{$_SESSION['mail']}'";
...
if (isset($_POST["UpdateQuestion"])) {
    ...
    $query = "UPDATE `skill_questions` SET `Questions`='$questionName',`Option1`='$option1',`Option2`='$option2',`Option3`='$option3',
    ...
    if ($result) {
        echo"
            <script>
                ...
                document.location.href = 'viewSkillQuestions.php';
            </script>
            ";
    } else {
