...
if (isset($_POST["submitQuestion"])) {
    ...
    $query = "INSERT INTO `skill_questions`(`email`, `Questions`, `Option1`, `Option2`, `Option3`, `Option4`, `right_option`, `skills`) 
...
<body>
    ...
    <!-- heading -->
    <h1 class="interQuestionhead">Add Skill Questions</h1>
        ...
        <div class="interQuestion">
            ...
            <div class="letsgoright">
                <div class="internQuestionthing">
                    <button type="submit" value="submit" name="submitQuestion">Submit and Add another</button>
                </div>
            </div>
        </div>
    </form>
